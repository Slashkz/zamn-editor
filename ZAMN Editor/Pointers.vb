Public Class Pointers
    ...
    Public Const Passwords As Integer = &H280BE '+
    Public Const ItemGFX As Integer = &H7DB84 '+
    Public Const TitlePalette As Integer = &HE3D82 '+
    ...
    'Public Shared SuggestTilesets As Integer() = {&HBB5A2, &HD36A2, &HC35A2, &HCB5A2, &HDB6A2} '+
    Public Shared SuggestTilesets As Integer() = {&H100000, &H118100, &H108000, &H110000, &H120100} '+
    Public Shared SpritePtrs As Integer() = {-1, &H12B7E, &H11E44, &H12668, &H128EE, &H12748, &H11CF0, &H12164, &H11F7C, &H1236C, &H129EC, &H12550,
                                             ...
                                             &H19E10, &H19D34, &H174B6, &H17A8E, &H1B1A8, &H1CE4A, &H1CF32, &H1B698, &H227B8, 1, 2, &H136E4}
    Public Shared SpriteOffsets As Integer() = {0, 0, 24, 47, 17, 29, 13, 38, 17, 38, 29, 40, 31, 63, 16, 47, 16, 29, 14, 32, 16, 37, 28, 44,
                                                ...
                                                26, 26, 19, 21, 17, 34, 24, 30, 9, 22, 8, 16, 16, 32, 12, 16, 8, 12, 0, 0, 0, 0, 0, 0}
    ...
    Public Shared MusicResource As Integer() = {&H6B90, &H6B96, &H6B9C, &H6BA2} 'Samples, Sequences, Envelopes, Patch
    Public Shared MusicResourcePtrs As Integer() = {0, 0, 0, 0} 'Samples, Sequences, Envelopes, Patch
    ...
    Public Shared Tilesets As Integer() = {&H100000, &H118100, &H110000, &H120100, &H108000} '+
    ...
    'Public Shared EndOfHeaders As Integer = &H321EC
    Public Shared EndOfHeaders As Integer = &H321EC
    ...
    Public Shared PltAnim As Integer() = {0, &H3364, 0, &H3294, &H32FE, &H33BE} '_, Castle, Grass, Beach, Pyramid, Fire Cave
    Public Shared Boss As Integer() = {-1, &H2012A, &H2142A, &H23E14, &H23E1E, &H31DC, &H261E, &H220E2} '+

    Public Const RAMStartGens As Integer = &H2478
    Public Const RAMLevelNum As Integer = &HF9C9
    Public Const RAMWeaponQty As Integer = &HFA74
    Public Const RAMStartingVictims As Integer = &HFC68
    Public Const RAMRemainingVictims As Integer = &HFC6A
    ...
    Public Shared Sub FillDictionary(ByVal Src As Integer(), ByVal Dest As Integer(), ByRef dictionary As Dictionary(Of Integer, Integer))
        Dim i As Integer = 0
        For Each X As Integer In Src
            dictionary(X) = Dest(i)
            i = i + 1
        Next
    End Sub
