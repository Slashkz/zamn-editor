Public Class PointersSNES
    ...
    Public Shared SpritePtrs As Integer() = {-1, &H19FE2, &H19776, &H19C6D, &H19E15, &H19D00, &H19699, &H1993D, &H19843, &H19A89, &H19EBE, &H19BAD,
                                             &H16F36, &H983A, &HA455, &H1725D, &HD2F1, &HD2F9, &H1B55E, &H1B7F6,
                                             &H87F8, &H88CA, &H8C17, &H8E89, &H8F1F, &H99DF, &H9A3E, &HABF5, &HB2B0, &HB664, &HC1FB,
                                             &HC321, &HC3B6, &HC87B, &HCCCF, &HD704, &HE481, &HE51A, &H1190F, &H1B277, 1, 2, &H15D52}
    ...
    Public Shared Palettes As Integer() = {&HF0E76, &HF1076, &HF1176, &HF1276, 0,
                                    &HF1C76, &HF1D76, 0, 0, 0,
                                    &HF1876, &HF1976, &HF1A76, &HF1B76, 0,
                                    &HF1E76, &HF2076, &HF2176, &HF2276, &HF1F76,
                                    &HF1476, &HF1576, &HF1676, &HF1776, 0}
    Public Shared PalNames As String() = {"Standard", "Fall", "Winter", "Night", "",
                                   "Mall", "Factory", "", "", "",
                                   "Standard", "Night", "Bright", "Dark", "",
